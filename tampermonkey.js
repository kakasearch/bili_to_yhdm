...
(function() {
    ...
    function change_url(){
        ...
        if(a){
            a.href='http://www.yhdm.so/search/'+ handle_name(a.innerText)
            ...
            //let newnode=document.createRange().createContextualFragment(`<img src='${img}'>`)
            //a.parentNode.insertBefore(newnode,a.nextElementSibling)
        }
    }
/*     let i = setInterval(function(){
         let a = document.querySelector("#media_module > div > a")
             if(a || /bili/.test(a.href)){
              change_url()
             }
    },100) */
